          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="product__item">
                ...
                <div class="product__item__text">
                  <h6>
                    <a href="#">듀먼 강아지화식 우주최저가 골라담기 50g 50팩</a>
                  </h6>
                  <h5>39,500원</h5>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="product__item">
                ...
                <div class="product__item__text">
                  <h6>
                    <a href="#">듀먼 강아지화식 우주최저가 골라담기 50g 40팩</a>
                  </h6>
                  <h5>34,000원</h5>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="product__item">
                ...
                <div class="product__item__text">
                  <h6>
                    <a href="#">듀먼 강아지화식 우주최저가 골라담기 50g 30팩</a>
                  </h6>
                  <h5>27,000원</h5>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="product__item">
                ...
                <div class="product__item__text">
                  <h6>
                    <a href="#">듀먼 강아지화식 우주최저가 골라담기 100g 50팩</a>
                  </h6>
                  <h5>55,000원</h5>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="product__item">
                ...
                <div class="product__item__text">
                  <h6>
                    <a href="#">듀먼 강아지화식 우주최저가 골라담기 100g 40팩</a>
                  </h6>
                  <h5>48,000원</h5>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="product__item">
                ...
                <div class="product__item__text">
                  <h6>
                    <a href="#">듀먼 강아지화식 우주최저가 골라담기 100g 30팩</a>
                  </h6>
                  <h5>39,000원</h5>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="product__item">
                ...
                <div class="product__item__text">
                  <h6>
                    <a href="#">듀먼 닭가슴살&초록입홍합 튼튼관절 100g</a>
                  </h6>
                  <h5>1,900원</h5>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="product__item">
                ...
                <div class="product__item__text">
                  <h6>
                    <a href="#">듀먼 닭가슴살&토마토 튼튼체력 100g</a>
                  </h6>
                  <h5>1,900원</h5>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="product__item">
                ...
                <div class="product__item__text">
                  <h6>
                    <a href="#">듀먼 닭가슴살&연어 빛나는 피모 100g..</a>
                  </h6>
                  <h5>1,900원</h5>
                </div>
              </div>
